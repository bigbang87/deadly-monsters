...
public class ModelStranger<T extends Entity> extends EntityModel<T>
{
	RendererModel body;
	RendererModel stomach;
	RendererModel leftleg;
	RendererModel rightleg;
	RendererModel leftarm;
	RendererModel rightarm;
	RendererModel lefthead;
    RendererModel righthead;
  ...
  public ModelStranger()
  {
    ...
    righthead = new RendererModel(this, 29, 31);
