...
public class ModelBaby<T extends Entity> extends EntityModel<T>
{
  //fields
    RendererModel head;
    RendererModel body;
    RendererModel bodybig;
    RendererModel bodymiddle;
    RendererModel bodyleft;
    RendererModel rightarm;
    RendererModel leftarm;
    RendererModel leg;
    RendererModel righteye;
    RendererModel lefteye;
    RendererModel mounth;
  ...
  public ModelBaby()
  {
    ...
    bodyleft = new RendererModel(this, 0, 46);
    ...
    lefteye = new RendererModel(this, 39, 12);
    ...
    mounth = new RendererModel(this, 48, 0);
