...
public class ModelTopielec extends ModelBase
{
  ...
  public ModelTopielec()
  {
    ...
    leftfoot.setRotationPoint( 2F, 7F, -3);
    leftfoot.setTextureSize(64, 64);
    leftfoot.mirror = true;
    setRotation(leftfoot, 0F, 0F, 0F);
    leftupperleg.addChild(leftfoot);
    ...
    rightlowerleg.setRotationPoint(1F, 4F, 0F);
    ...
    rightfoot.setRotationPoint(1F, 7F, -3F);
    rightfoot.setTextureSize(64, 64);
    rightfoot.mirror = true;
    setRotation(rightfoot, 0F, 0F, 0F);
    rightupperleg.addChild(rightfoot);
    ...
    lefteye.setRotationPoint(0F, -6F, -6F);
    ...
    righteye.setRotationPoint(-3F, -6F, -6F);
    ...
    mouth.setRotationPoint(-2.5F, -3F, -6F);
