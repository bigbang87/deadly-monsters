...
public class ModEntities {
    ...
    public static void init() {
    	...
    	if (!ModConfig.mobsDisable) {
	        ...
	        //Haunted Cow
	        EntityRegistry.registerModEntity(EntityHauntedCow.class, "hauntedcow", id++, MainMod.instance, 64, 3, true);
			...
			//Topielec
	        EntityRegistry.registerModEntity(EntityTopielec.class, "topielec", id++, MainMod.instance, 64, 3, true);
